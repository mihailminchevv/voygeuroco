/* ── DATA ── */
const attractions = [
  { id: 1, name: "Cathedral of the Assumption", category: "Tourist Place", description: "One of Bulgaria's largest cathedrals, consecrated in 1886. Its soaring neo-Byzantine domes dominate the Varna skyline and the interior is covered in spectacular frescoes and golden iconostases.", city: "Varna", lat: 43.2047, lng: 27.9100, image: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Varna_-_Cathedral_%281%29.jpg/800px-Varna_-_Cathedral_%281%29.jpg" },
  { id: 2, name: "Sea Garden", category: "Tourist Place", description: "An 80‑hectare coastal park along the Black Sea established in the 1880s. Home to the Dolphinarium, Summer Theatre, Naval Museum, and miles of beautiful seaside walkways.", city: "Varna", lat: 43.2045, lng: 27.9222, image: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Varna_sea_garden.jpg/1280px-Varna_sea_garden.jpg" },
  { id: 3, name: "Archaeological Museum", category: "Tourist Place", description: "Houses the world's oldest processed gold treasure — the Varna Chalcolithic Necropolis collection, dating to 4600–4200 BC. An essential visit for anyone interested in ancient history.", city: "Varna", lat: 43.2074, lng: 27.9149, image: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/22/Varna_Archaeological_Museum.jpg/800px-Varna_Archaeological_Museum.jpg" },
  { id: 4, name: "Roman Thermae", category: "Tourist Place", description: "The largest ancient Roman baths on the Balkan Peninsula, built in the 2nd–3rd century AD. The ruins cover 7,000 sq metres and still stand nearly 20 metres high in places.", city: "Varna", lat: 43.2003, lng: 27.9175, image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Roman_Thermae_-_Varna_-_panoramio.jpg/800px-Roman_Thermae_-_Varna_-_panoramio.jpg" },
  { id: 5, name: "Euxinograd Palace", category: "Tourist Place", description: "A stunning Bulgarian royal residence set in a large park on the Black Sea coast, built in 1882. Famous for its French‑style gardens and award‑winning estate winery.", city: "Varna", lat: 43.2192, lng: 27.9892, image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Evksinograd_2.jpg/800px-Evksinograd_2.jpg" },
  ...
  { id: 8, name: "Aladzha Monastery", category: "Hidden Gem", description: "A medieval Orthodox cave monastery in the forest near Varna, with serene surroundings and historical significance.", city: "Varna", lat: 43.2778, lng: 28.0164, image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Aladzha_monastery.jpg/800px-Aladzha_monastery.jpg" },
  ...
  { id: 13, name: "Varna Zoo", category: "Tourist Place", description: "The central zoo of Varna – classic and well-known, located in the Sea Garden.", city: "Varna", lat: 43.2147, lng: 27.9353, image: "https://upload.wikimedia.org/wikipedia/commons/7/7d/Varna_Zoo.jpg" },
  { id: 14, name: "Talyana Art District", category: "Hidden Gem", description: "Street alley with graffiti and art installations in the historic center.", city: "Varna", lat: 43.2015, lng: 27.9150, image: "https://upload.wikimedia.org/wikipedia/commons/5/51/Street_Art_Varna.jpg" },
  { id: 15, name: "Small Roman Thermae", category: "Hidden Gem", description: "Small archaeological ruins of the Roman forum, a quiet spot in the Greek Quarter.", city: "Varna", lat: 43.2014, lng: 27.9201, image: "https://upload.wikimedia.org/wikipedia/commons/3/3e/Varna_Roman_Forum.jpg" },
  { id: 16, name: "St. Nicholas Church", category: "Hidden Gem", description: "Beautiful Orthodox church near the pedestrian zone with a peaceful atmosphere.", city: "Varna", lat: 43.2025, lng: 27.9189, image: "https://upload.wikimedia.org/wikipedia/commons/0/02/St_Nicholas_Varna.jpg" },
  { id: 17, name: "Naval Museum Yard", category: "Hidden Gem", description: "Outdoor part of the Naval Museum featuring the Drazki ship and helicopters.", city: "Varna", lat: 43.2008, lng: 27.9221, image: "https://upload.wikimedia.org/wikipedia/commons/6/6f/Maritime_Museum_Varna.jpg" },
  { id: 18, name: "Sea Garden Alpinarium", category: "Hidden Gem", description: "Hidden rocky garden with bridges, ideal for a peaceful walk.", city: "Varna", lat: 43.2085, lng: 27.9302, image: "https://upload.wikimedia.org" },
  { id: 19, name: "Varna State Archives", category: "Hidden Gem", description: "Stunning historic building, a masterpiece of early 20th-century architecture.", city: "Varna", lat: 43.2038, lng: 27.9125, image: "https://upload.wikimedia.org" },
  { id: 20, name: "Underground Basilica Ruins", category: "Hidden Gem", description: "Ancient basilica remains located below the modern street level.", city: "Varna", lat: 43.2018, lng: 27.9180, image: "https://upload.wikimedia.org" },
  { id: 21, name: "The Dragon Sculpture", category: "Hidden Gem", description: "Bronze sculpture of two dragons, a famous local hidden spot near the sea.", city: "Varna", lat: 43.2005, lng: 27.9228, image: "https://upload.wikimedia.org" },
  { id: 22, name: "City Art Gallery", category: "Hidden Gem", description: "The Boris Georgiev gallery, set in a historic Gothic-style building.", city: "Varna", lat: 43.2068, lng: 27.9172, image: "https://upload.wikimedia.org" },
  { id: 23, name: "The Re-Born Tree", category: "Hidden Gem", description: "Artistic wood carving on a dead tree trunk, a unique sight in the park.", city: "Varna", lat: 43.2062, lng: 27.9268, image: "https://upload.wikimedia.org" },
  { id: 24, name: "Officer's Beach Viewpoint", category: "Hidden Gem", description: "Panoramic terrace with an incredible view of the sea bay.", city: "Varna", lat: 43.2162, lng: 27.9405, image: "https://upload.wikimedia.org" },
  { id: 25, name: "Eco Park Varna", category: "Hidden Gem", description: "University Botanical Garden – a vast park perfect for a nature escape.", city: "Varna", lat: 43.2325, lng: 28.0018, image: "https://upload.wikimedia.org" }
  ];
/* ── STATE ── */
let dirFilter = 'all';
let mapFilter = 'all';
